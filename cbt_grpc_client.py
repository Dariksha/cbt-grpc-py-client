...
with open("cbt_config.json", "r") as f:
    CONFIG = json.load(f)

PC_IP = CONFIG["PC_IP"]
RECOVERY_POINT_EXT_ID = CONFIG["RECOVERY_POINT_EXT_ID"]
VM_RECOVERY_POINT_EXT_ID = CONFIG["VM_RECOVERY_POINT_EXT_ID"]
DISK_RECOVERY_POINT_EXT_ID = CONFIG["DISK_RECOVERY_POINT_EXT_ID"]
REFERENCE_RECOVERY_POINT_EXT_ID = CONFIG["REFERENCE_RECOVERY_POINT_EXT_ID"]
REFERENCE_DISK_RECOVERY_POINT_EXT_ID = CONFIG["REFERENCE_DISK_RECOVERY_POINT_EXT_ID"]
REFERENCE_VM_RECOVERY_POINT_EXT_ID = CONFIG["REFERENCE_VM_RECOVERY_POINT_EXT_ID"]
...
def fetch_jwt_token():
    ...
    headers = {
        ...
        "Authorization": "Basic YWRtaW46TnV0YW5peC4xMjM="  # Replace with secure header in prod
    }
